...
let frames = 0
let randomInterval = Math.floor((Math.random() * 2000) + 500)
let game = {
    over: false,
    active: true
}
        ...
        grid.invaders.forEach((invader, index) => {
            ...
            projectiles.forEach((projectile, j) => {
                if (projectile.position.y - projectile.radius <=
                    ...
                    setTimeout(() => {
                        const invaderFound = grid.invaders.find(invader2 => invader2
                            === invader)
                        const projectileFound = projectiles.find(projectile2 => projectile2
                            === projectile)
